...
parser = argparse.ArgumentParser(description='LightGBM fast, distributed, high performance gradient boosting framework')
...
args.data  # location of your data on disk
...
binary_train = f'{args.data}/binary.train'
df_train = pd.read_csv(binary_train, header=None, sep='\t')
binary_test = f'{args.data}/binary.test'
df_test = pd.read_csv(binary_test, header=None, sep='\t')
weight_train = f'{args.data}/binary.train.weight'
W_train = pd.read_csv(weight_train, header=None)[0]
weight_test = f'{args.data}/binary.test.weight'
W_test = pd.read_csv(weight_test, header=None)[0]
